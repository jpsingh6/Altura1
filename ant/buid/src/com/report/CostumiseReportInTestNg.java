 ...
 * Created by VISISHTA.
 */
public class CostumiseReportInTestNg implements IReporter{
	...
	private void tableStart(String cssclass, String id) {
		...
		("style='padding-bottom:2em'") + ("id != null ?  id=" + id + ">")));
				m_row = 0;
	}
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println("<html xmlns=1http://www.w3.org/1999/xhtml'>");
		out.println("<head>");
