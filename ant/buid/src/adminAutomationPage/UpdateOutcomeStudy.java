...
public class UpdateOutcomeStudy extends SetupForExcel{
							 ...
							 String userid) throws InterruptedException
	{
		...
		Thread.sleep(5000);
		page.searchOutcomeStudy.sendKeys(StudyTitle1);
		
		Thread.sleep(3000);
		action.moveToElement(page.updateClick);
		action.click().build().perform();
		//action.moveToElement(page.addOutcomeStudy);
		//action.click().build().perform();
		Thread.sleep(6000);
		page.studyTitle.clear();
		...
		action2.moveToElement(page.ClearData).click().build().perform();
